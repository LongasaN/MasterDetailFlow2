package com.example.nina.masterdetailflow2;
...
import com.example.nina.masterdetailflow2.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.webpage_detail)).setText(mItem.url);
        }
